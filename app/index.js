...
// Create object that will hold all of the code needed to pass to the PistacheoGenerator
var tasks = {};
...
var PistacheoGenerator = yeoman.generators.Base.extend(_.merge({
  init: function() {
    this.pkg = JSON.parse(this.readFileAsString(path.join(__dirname, '../package.json')));
  }
}, tasks));

module.exports = PistacheoGenerator;
